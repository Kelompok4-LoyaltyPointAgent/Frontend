...
const CardTopPaket = () => {
    return (
        <div className='d-flex flex-row flex-wrap justify-content-between'>
            ...
            style={{ borderRadius: '10px', borderLeftColor: '#2B669F', borderLeftWidth:'4px',width: '25rem', padding: '10px' }}>
                <span className='mt-2 mb-2 ms-2'><h5>Stok Produk</h5></span>
                <span className='mb-2 ms-2' style={{color:'#2B669F'}}><h5>1.517</h5></span>
            </Card>
            <Card className='d-flex' 
            style={{ borderRadius: '10px', borderLeftColor: '#559CC0', borderLeftWidth:'4px',width: '25rem', padding: '10px' }}>
            ...
            <Card className='d-flex' 
            style={{ borderRadius: '10px', borderLeftColor: '#CC8A93', borderLeftWidth:'4px',width: '25rem', padding: '10px' }}>
