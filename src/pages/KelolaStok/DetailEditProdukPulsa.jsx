        ...
        <Card border='dark'>
          ...
          <Card.ImgOverlay>
              <Row>
                ...
                <p className='mt-4' style={{color:'white'}}><h4>Detail Produk</h4></p>
                ...
                <div><img style={{marginTop:'13px',height:'110px',width:'125px'
                , zIndex:'2', top:'0px',position:'relative'}} 
                alt='iconpoin' src={require('../../assets/images/ProdukPulsa/Rectangle 15.png')}/>
                <div className='text-center' style={{padding:'3px', zIndex:'9', position:'absolute', top:'30px', color: '#013B75'}}>
                  <p style={{margin:'0px', marginTop:'2px', marginLeft:'30px'}}><h5>Reward</h5></p>
                  <p style={{margin:'0px', marginTop:'2px', marginLeft:'30px'}}><h4>777</h4></p>
                  </div>
                </div>
                </Col>
              </Row>
